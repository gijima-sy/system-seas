<?php
    ...
    try {
        $consulta = $pdo->query("SELECT * FROM rotina_medica");
?>
...
?>
           <tbody>
                <tr>
                    ...
                    <td> <button class="login button-tabela" onclick="location.href='./form-editar-dados-rotina.php?id=<?= $linha['id'] ?>'" class="btn">Editar</button> <button class="login button-tabela" onclick="location.href='../keys/delete-excluir-rotina.php?id=<?= $linha['id']?>'" class="btn">Excluir</button></td>
                </tr>
           </tbody>
<?php
        }
