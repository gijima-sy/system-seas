...
<body>
    <main class = "container">
        <H1> Crie Sua Primeira Rotina Medicamentos No SEAS </H1>
        ...
        <form  action="../keys/create-rotina-medica.php" method="POST">
            ...
            <div class="input-box">
                <p>
                    ...
                    <input type="text" name="dose" id="dose-id"  placeholder="Digite a dose (em gramas) do seu medicamento:">
                </p> 
            </div>
            ...
            <div class="input-box">
                ...
                <p>
                    ...
                    <input type="text" name="horario" id="horario-id"  placeholder="Digite o intervalo de tempo para tomar a medicação:">
                </p>
